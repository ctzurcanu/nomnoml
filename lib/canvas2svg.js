...
;(function() {
    ...
    ctx.prototype.setLineDash = function(array){
        //options.dash = array.join(",");
        //STYLES.lineDash.canvas = array.join(",")
        this.__applyStyleState(STYLES.lineDash , array.join(","))
        //console.info(array.join(","))
        //this.__applyStyleState({STYLES[lineDash: { canvas: array.join(",")}})
        this.__applyStyleToCurrentElement("lineDash");
    }
    ctx.prototype.arcTo = function(x1, y1, x2, y2, radius) {
        //this.moveTo(x1, y1);
        //this.__addPathCommand(format("a {rx} {ry} {xAxisRotation} {largeArcFlag} {sweepFlag} {endX} {endY}", {rx:radius, ry:radius, xAxisRotation:0, largeArcFlag:0, sweepFlag:0, endX:x2-x1, endY:y2-y1}));
    }
